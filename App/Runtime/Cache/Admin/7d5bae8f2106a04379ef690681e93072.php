...
﻿ 
        ...
        <div class="page-title">
            ...
            <div class="page-breadcrumb">
                <ol class="breadcrumb">
                    <li>
                        <a href="<?php echo U('Product/index');?>">用户管理</a>
                    </li>
                    <li>
                        <a href="<?php echo U('Product/cate');?>">管理员列表</a>
                    </li>
                </ol>
            </div>
        </div>
  ...
  <form action="/wepay/admin.php/Admin/index?name=&amp;pid=" method="get">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">添加管理员</h4></div>
      <div class="modal-body">



  <form action="/wepay/admin.php/Admin/cateAdd" method="post" id="addRes">  
              ...
              <div class="panel panel-white">
                <div class="panel-body form-horizontal">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <input type="password" class="form-control" placeholder="确认密码" name="c_password" value=""/>
                      </div>
                    </div>                    
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">编辑管理员</h4></div>
      <div class="modal-body">


  <form action="/wepay/admin.php/Admin/cateEdit" method="post" id="upRes">  
...
var vue=new Vue({
  el: '#app',
  data:{
    adminList:<?php echo json_encode($adminList);?>,
    checkedNames:[],
    check:false,
    upData:{}
  },
  methods: {
    addProduct:function(id,closeId){
      ...
      this.$http.post('/wepay/admin.php/Admin/addAdmin',fields,{emulateJSON:true} ).then(response => {
            ...
            if( this.checkedNames.length <= 0 ){
              ...
              layer.confirm('是否删除?', {icon: 3, title:'删除'}, function(index){
                /**************************/  
                    ...
                    // post
                    _this.$http.post('/wepay/admin.php/Admin/delProduct',data,{emulateJSON:true} ).then(response => {
                      if(response.body.error==0){
                        toastr.success( response.body.msg );
    ...
    upDate:function(id){
      // alert(id);
      this.$http.get('/wepay/admin.php/Admin/getProduct/id/'+id,{},{emulateJSON:true} ).then(response => {
